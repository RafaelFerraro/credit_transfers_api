  ...
  context "when creating bulk transfers" do
    ...
    context "when there isn't enough balance to proccess the transfers" do
      xit "raises InsufficientBalanceError" do
        ...
        allow(bank_account).to receive(:sufficient_balance_for?)
          .with("6125250.0").and_return(false)
